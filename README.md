...
This project was designed using HTML5, CSS and javaScript and it enhances overall user experience and visual appeal. It has the one section. This section contains:
-A title.
-A card containing an image, meal name, ingredients and a video link on how to prepare the meal.
...
-**Custom properties**: Used CSS variables to apply the correct color theme, margins and borders.
...
```bash 
git clone https://github.com/FaridaAdamuMagaji/Recipe-website.git    
...
<body>
 <section>
  <!--div containing meal and preparation method-->
 </section>
